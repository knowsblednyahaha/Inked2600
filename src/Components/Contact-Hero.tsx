  ...
  return (
    <section className="contact-hero-container noselect" data-scroll-section>
      <div className="marquee">
        <h5 data-scroll>
          get to <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us - get to{" "}
          ...
          <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us - get to{" "}
          <span className="white">know</span> us
        </h5>
        <br />
        <h5 data-scroll>
          get to <span className="white">know</span> us - get to{" "}
      ...
      <div className="contact-text-container">
        <div className="big-text-container" ref={hi}>
          <h5 data-scroll>
            {" "}
            Say{" "}
            <a href="mailto:inked2600@gmail.com" data-scroll>
              {" "}
              Hi!
            </a>
          </h5>
        ...
        <div className="description-container">
          <div className="text-description" ref={textDesc} data-scroll>
            <p>
              By looking at both our tattoo fill in and our workmanship, one can
              see that we are unique yet dependable, and that we can adapt to a
          ...
          <div className="social-media-container">
            <div
              ...
              ref={(element) => {
                line.current[0] = element;
              }}
            >
              <a
                href="https://www.facebook.com/profile.php?id=100087213424052"
                target="_blank"
                rel="noopener noreferrer"
                ref={(element) => {
                  socmed.current[0] = element;
                }}
                data-scroll
              >
                Facebook
            ...
            <div
              className="social-media-item"
              ref={(element) => {
                line.current[1] = element;
              }}
            >
              <a
                href="https://www.instagram.com/inkedtwosixx/"
                target="_blank"
                rel="noopener noreferrer"
                ref={(element) => {
                  socmed.current[1] = element;
                }}
                data-scroll
              >
                Instagram
